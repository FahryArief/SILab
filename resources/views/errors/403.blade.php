    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(-45deg, #1a0a0a, #2d1320, #1e0c2a, #0f0c29);
        ...
        .orb-1 { width: 400px; height: 400px; background: linear-gradient(135deg, #f5576c, #ff6b6b); top: -10%; right: -5%; }
        .orb-2 { width: 350px; height: 350px; background: linear-gradient(135deg, #ee5a6f, #764ba2); bottom: -10%; left: -5%; animation-delay: 2s; animation-duration: 10s; }
        ...
        .icon-wrap {
            ...
            background: linear-gradient(135deg, rgba(245, 87, 108, 0.15), rgba(239, 68, 68, 0.1));
        ...
        @keyframes iconPulse {
            0%, 100% { box-shadow: 0 0 0 0 rgba(245, 87, 108, 0.15); }
            50% { box-shadow: 0 0 0 15px rgba(245, 87, 108, 0); }
        }

        .icon-wrap svg { width: 40px; height: 40px; color: #f5576c; }

        .error-code {
            font-size: clamp(100px, 18vw, 180px); font-weight: 900; line-height: 1;
            background: linear-gradient(135deg, #f5576c, #ff6b6b, #ee5a6f, #f5576c);
        ...
        .btn-primary {
            ...
            padding: 0.875rem 2rem; background: linear-gradient(135deg, #f5576c, #ee5a6f);
            color: #fff; font-size: 0.875rem; font-weight: 600; border: none;
            border-radius: 0.875rem; cursor: pointer; text-decoration: none;
            transition: all 0.3s ease; box-shadow: 0 8px 25px -5px rgba(245, 87, 108, 0.4);
            position: relative; overflow: hidden;
        }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 35px -5px rgba(245, 87, 108, 0.5); }
        ...
        .logo-ring { background: linear-gradient(135deg, #f5576c, #ee5a6f); padding: 3px; border-radius: 9999px; box-shadow: 0 0 20px rgba(245, 87, 108, 0.4), 0 0 40px rgba(245, 87, 108, 0.1); display: inline-block; margin-bottom: 0.5rem; }
...
<body>
    ...
    <div class="container">
        ...
        <p class="description">Maaf, kamu tidak memiliki izin untuk mengakses halaman ini. Hubungi administrator jika kamu merasa ini adalah kesalahan.</p>
        ...
        <div class="actions">
            ...
            <a href="javascript:history.back()" class="btn-secondary">
                <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"/></svg>
                Halaman Sebelumnya
            </a>
        </div>
    </div>
