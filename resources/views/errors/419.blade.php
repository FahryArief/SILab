    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(-45deg, #0f0c29, #1e1845, #24243e, #1a1a2e);
        ...
        .orb-1 { width: 400px; height: 400px; background: linear-gradient(135deg, #8b5cf6, #6366f1); top: -10%; right: -5%; }
        .orb-2 { width: 350px; height: 350px; background: linear-gradient(135deg, #a78bfa, #818cf8); bottom: -10%; left: -5%; animation-delay: 2s; animation-duration: 10s; }
        ...
        .error-code {
            ...
            background: linear-gradient(135deg, #8b5cf6, #a78bfa, #6366f1, #8b5cf6);
        ...
        .btn-primary {
            ...
            padding: 0.875rem 2rem; background: linear-gradient(135deg, #8b5cf6, #6366f1);
            color: #fff; font-size: 0.875rem; font-weight: 600; border: none;
            border-radius: 0.875rem; cursor: pointer; text-decoration: none;
            transition: all 0.3s ease; box-shadow: 0 8px 25px -5px rgba(139, 92, 246, 0.4);
            position: relative; overflow: hidden;
        }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 35px -5px rgba(139, 92, 246, 0.5); }
        ...
        .logo-ring { background: linear-gradient(135deg, #8b5cf6, #6366f1); padding: 3px; border-radius: 9999px; box-shadow: 0 0 20px rgba(139, 92, 246, 0.4), 0 0 40px rgba(139, 92, 246, 0.1); display: inline-block; margin-bottom: 0.5rem; }
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="title">Sesi Telah Kadaluarsa</h1>
        <p class="description">Sesi kamu telah berakhir karena tidak aktif terlalu lama. Silakan muat ulang halaman dan coba lagi.</p>
