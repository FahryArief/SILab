...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    @if(auth()->user()->role === 'kepala_lab')
        ...
        <x-nav-link :href="route('admin.tahun_ajaran.index')" :active="request()->routeIs('admin.tahun_ajaran.*')">
            {{ __('Tahun Ajaran') }}
        </x-nav-link>
    @endif
    ...
    @if(auth()->user()->role === 'peminjam')
        <x-nav-link :href="route('peminjam.katalog.barang')" :active="request()->routeIs('peminjam.katalog.barang')">
            {{ __('Pinjam Barang') }}
        </x-nav-link>
        <x-nav-link :href="route('peminjam.katalog.ruangan')" :active="request()->routeIs('peminjam.katalog.ruangan')">
            {{ __('Booking Ruangan') }}
        </x-nav-link>
